...
const services = [
  {
    ...
    features: ['Multi-Cloud Migration', 'DevOps Automation', 'Serverless Architecture'],
  },
  {
    id: 'data',
    Icon: AnalyticsIcon,
    title: 'Data & Analytics',
    description: 'Turn data into decisions with powerful analytics solutions.',
    features: ['AI Predictive Modeling', 'Real-time Dashboards', 'Data Warehousing'],
  },
  {
    id: 'security',
    Icon: SecurityIcon,
    title: 'Cyber Security',
    description: 'Protect what matters with advanced security measures.',
    features: ['Zero Trust Security', 'Threat Detection & AI', 'Compliance Audits'],
  },
  {
    id: 'digital',
    Icon: TransformIcon,
    title: 'Digital Transformation',
    description: 'Innovate and transform with next-gen technologies.',
    features: ['Legacy Modernization', 'Custom Web & Mobile', 'API & Cloud Integrations'],
  },
];
